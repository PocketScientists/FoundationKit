...
- (NSString *)fkit_relativeDateString {
	...
	return [self fkit_dateStringWithDateStyle:NSDateFormatterShortStyle timeStyle:NSDateFormatterNoStyle];
...
- (NSString *)fkit_dateStringWithDateStyle:(NSDateFormatterStyle)dateStyle timeStyle:(NSDateFormatterStyle)timeStyle {
  NSDateFormatter* formatter = dateFormatter();
